            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="slider-zoom">
                        <a href="{{asset($fruit->image)}}" class="cloud-zoom" rel="transparentImage: 'data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==', useWrapper: false, showTitle: false, zoomWidth:'500', zoomHeight:'500', adjustY:0, adjustX:10" id="cloudZoom">
                            <img alt="Detail Zoom thumbs image" src="{{asset($fruit->image)}}" style="width: 100%;">
                        </a>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <p>
                                ...
                                <span class="price">Rp'S. {{$fruit->price}}</span>
                                {{-- <span class="old-price">Rp 150.000</span> --}}
                            </p>
                        </div>
                        <div class="col-sm-6 text-right">
                            <p>
                                <span class="stock available">In Stock: {{$fruit->quantity}}</span>
                            </p>
                        </div>
                    </div>
                    <form action="{{route('cart.add')}}" method="post">
                        ...
                        <input type="hidden" name="f_id" value="{{$fruit->id}}">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="product-carousel owl-carousel">
                        @foreach($fruits->products()->orderBy('created_at','desc')->take(4)->get() as $fruit)
                        <div class="item">
                            <div class="card card-product">
                                ...
                                <div class="card-badge">
                                    ...
                                    <img src="{{asset($fruit->image)}}" width="60" height="120" alt="Card image 2" class="card-img-top">
                                </div>
                                <div class="card-body">
                                    <h4 class="card-title">
                                    ...
                                    <div class="card-price">
                                        <span class="regulat">Stock. {{$fruit->quantity}}</span>
